    ...
    navigation.setOptions({
      headerRight: () => (
        <Button
          onPress={() =>
            Alert.alert(
              "Welcome to the " + route.params.item_name + " section!",
            ...
            <View style={styles.mainComponent}>
              <View style={styles.reviewComponent}>
                ...
                <View style={styles.rowView}>
                  <Text style={styles.moneyText}>
                    Value for money:{" "}
                    <Text style={styles.bold}> {item.money}</Text>/5
                  </Text>
                  <Text style={styles.tasteText}>
                    Taste: <Text style={styles.bold}> {item.taste}</Text>/5
                  </Text>
                </View>
                <View>
                  <Text>
              ...
              <View style={styles.secondaryComponent}>
                <View style={styles.reviewbuttons}>
                  ...
                  >
                    {/* <Text
                      style={{ color: "white", backgroundColor: "#000000c0" }}
                    >
                      Upvote!
                    </Text> */}
