...
import { Text, View, TouchableOpacity, StyleSheet, TextInput, Button, Keyboard, Alert, TouchableWithoutFeedback, Modal } from "react-native";
...
export default function ReviewScreen({ navigation, route }) {
    ...
    //Creating an info button at the top right corner of the screen
     React.useLayoutEffect(() => {
       navigation.setOptions({
         headerRight: () =>
         <Button 
         onPress={() => 
          Alert.alert("Welcome to the Rating section!", 
          "Place your finger on the knob of the slider and slide horizontally to your desired rating. \n\nClick the \"Type a review\" area and type out your review! \n\nSatisfied with your review? \n\nClick the \"Submit review!\" button to submit your review!", [{text: "Ok", onPress: () => console.log("pressed")}])} 
        title="?" />,
        })
      })
